...
<html>
    ...
    <nav id="izborniMeni">
        ...
        <div>
            ...
            $result = $veza->selectDB("SELECT e.Broj_dolazaka, e.Napredak, t.Naziv FROM Evidencija e, Termin t WHERE e.Termin_idTermin = t.idTermin AND Korisnik_idKorisnik = $korisnikID;");

            if ($result->num_rows > 0) {
                echo "<table align=center><tr><th>Broj dolazaka</th><th>Napredak</th><th>Naziv</th></tr>";

                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["Broj_dolazaka"] . "</td><td>" . $row["Napredak"] . "</td><td>" . $row["Naziv"] . "</td></tr>";
                }
                echo "</table>";
            } else {
                echo "0 results";
