...
<html>
    <head>
        <title>Otključaj</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="naslov"  content="otkljucaj"/>
        <meta name="ključne riječi"  content="teretana, otkljucaj"/>
    ...
    <body>
        ...
        <section>
            <form action="otkljucaj.php" method="post">
                <label>Korisničko ime koje želite otključati:</label>
                <input  id="username" type="text" name="username" placeholder="Korisničko ime">

                <input id="otkljucaj" type="submit" name="otkljucaj" value="Otključaj">
                <br><br>
            </form>
        </section>
