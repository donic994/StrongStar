...
<html>
    <head>
        <title>Dodjeli moderatora</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section>
            <form action="dodjeli_moderatora.php" method="post">
                <label>Korisničko ime kojeg želite postaviti moderatorom:</label>
                <input  id="username" type="text" name="username" placeholder="Korisničko ime">

                <input id="dodjeli" type="submit" name="dodjeli" value="Dodjeli">
                <br><br>
            </form>
        </section>
