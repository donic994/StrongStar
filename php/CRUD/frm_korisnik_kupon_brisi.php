...
<nav id="izborniMeni">
        ...
        <section>
            <form action="korisnik_kupon_brisi.php" method="post">
                <label>ID koji želite obrisati:</label>
                <input  id="koID" type="text" name="koID" placeholder="idKorisnik">
                <br>
                <label>ID koji želite obrisati:</label>
                <input  id="kuID" type="text" name="kuID" placeholder="idKupon">
