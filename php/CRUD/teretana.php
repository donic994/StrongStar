<html>
    <head>
        ...
        <meta name="ključne riječi"  content="teretana, teratana"/>
    ...
    <body>
        ...
        <div>
            ...
            $result = $veza->selectDB("SELECT * FROM Teretana");

            if ($result->num_rows > 0) {
                echo "<table align=center><tr><th>ID</th><th>Naziv</th><th>Adresa</th><th>Telefon</th><th>Radno vrijeme</th></tr>";

                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["idTeretana"] . "</td><td>" . $row["Naziv"] . "</td><td>" . $row["Adresa"] . "</td><td>" . $row["Telefon"] . "</td><td>" . $row["Radno_vrijeme"] . "</td></tr>";
                }
                echo "</table>";
            } else {
                echo "0 results";
        ...
        <div id="gumbici">
        <form action="frm_teretana_dodaj.php" method="post" >
            <input type="submit" name="dodaj" value="Dodaj">
        </form>
        <form action="frm_teretana_uredi.php" method="post" >
            <input type="submit" name="uredi" value="Uredi">
        </form>
        <form action="frm_teretana_brisi.php" method="post" >
