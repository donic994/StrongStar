<html>
    ...
    <body>
       ...
       <nav id="izborniMeni">
        ...
        <section>
            <form action="evidencija_zabrani.php" method="post">
                <label>ID korisnika:</label>
                <input  id="kID" type="text" name="kID" placeholder="idKorisnik">
                <br>
                <label>ID termina:</label>
                <input  id="tID" type="text" name="tID" placeholder="idTermin">

                <input id="brisi" type="submit" name="zabrani" value="Zabrani">
                <br><br>
            </form>
        </section>
